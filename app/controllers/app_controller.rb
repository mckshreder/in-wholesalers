class AppController < ApplicationController
  ...
  @disney_scrape = AppScraper.new('https://teamtreehouse.com/community/im-stuck-on-how-to-integrate-a-nokogiri-scrape-into-my-rails-application')
  @auditions = @disney_scrape.get_class_items('.productImageSection')
